...
namespace Company.Application.Share.Mouse
{
    ...
    /// 鼠标操作基类
    /// </summary>
    public abstract class MouseOperationBase(
        ...
        : ReactiveObject
    {
        ...
        /// 鼠标操作类型
        /// </summary>
        public MouseOperationType MouseOperationType { get; } = mouseOperationType;

        /// <summary>
        /// 预览图
        /// </summary>
        protected BitmapSourceGDI PreviewBitmap { get; } = previewBitmap;

        /// <summary>
        /// 缩放平移对象
        /// </summary>
        public ITransformProvider TransformGroup { get; } = transformGroup;
        ...
        public abstract void MouseLeftButtonDownAndMove(System.Windows.Point point,
            ref System.Windows.Input.Cursor cursor);
